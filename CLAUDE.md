...
app/                          # Next.js App Router
  ...
  api/admin/atlas/family-param-signatures/ # POST signature + retroactive reclassify RPC in one call (Decision #188)
