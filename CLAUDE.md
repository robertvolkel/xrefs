...
**Current MVP:** Cross-reference recommendation engine covering 39 passive, discrete semiconductor, IC, and frequency control families, with Digikey as the primary data source.
...
Each component family has a logic table in `lib/logicTables/` defining its matching rules. All 39 families are encoded:
