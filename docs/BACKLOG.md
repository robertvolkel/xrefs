...
All 19 passive families + 9 discrete semiconductor families (B1–B9) + 10 Block C IC families (C1 LDOs, C2 Switching Regulators, C3 Gate Drivers, C4 Op-Amps/Comparators, C5 Logic ICs, C6 Voltage References, C7 Interface ICs, C8 Timers/Oscillators, C9 ADCs, C10 DACs) + 1 Block D frequency control family (D1 Crystals) now have curated parameter maps. See Decisions #16-19, #30-40, #46-55, #71 for API quirks.
