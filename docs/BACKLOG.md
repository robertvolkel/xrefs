...
Jest test suite added with 231 tests across 6 suites, covering all priority candidates:
...
- `familyClassifier.test.ts` (28 tests) — all variant classifiers (54/55/53/60/13/72/B2/B3/B4), B5/B6/B7 standalone, cross-family safety, rectifier enrichment
...
- `digikeyMapper.test.ts` (81 tests) — category/subcategory/status mapping, SI prefixes, value transformers, MOSFET/BJT/IGBT routing, search result dedup
