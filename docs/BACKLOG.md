...
All 19 passive families + 9 discrete semiconductor families (B1–B9) + 7 Block C IC families (C1 LDOs, C2 Switching Regulators, C3 Gate Drivers, C4 Op-Amps/Comparators, C5 Logic ICs, C6 Voltage References, C7 Interface ICs) now have curated parameter maps. See Decisions #16-19, #30-40, #46-52 for API quirks.
