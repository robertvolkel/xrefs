...
function getGridColumns(phase: AppPhase, hasAttributes: boolean, recsRevealed: boolean): string {
  switch (phase) {
    case 'idle':
    case 'searching':
    case 'resolving':
    ...
    case 'viewing':
    case 'comparing':
      return hasAttributes ? '4fr 3fr 3fr' : '7fr 3fr 0fr';
    default:
      return '1fr 0fr 0fr';
  }
}
...
export default function AppShell() {
  ...
  return (
    <Box
      sx={{
        display: 'grid',
        gridTemplateColumns: getGridColumns(appState.phase, hasAttributes, recsRevealed),
        height: '100vh',
        width: '100vw',
        overflow: 'hidden',
    ...
    >
      ...
      <Box
        sx={{
          overflow: 'hidden',
          borderRight: showAttributesPanel ? 1 : 0,
          borderColor: 'divider',
      ...
      <Box
        sx={{
          ...
          borderRight: showRightPanel ? 1 : 0,
          borderColor: 'divider',
          minWidth: 0,
        }}
      >
