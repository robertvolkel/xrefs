...
/**
 * Global view template manager.
 * Templates are stored in localStorage and used to seed new lists.
 * For per-list view management, use useListViewConfig instead.
 */
...
/** @deprecated Use useViewTemplates instead */
export const useViewConfig = useViewTemplates;
