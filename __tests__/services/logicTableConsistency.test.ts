/**
 * Structural consistency tests for all 38 component family logic tables
...
describe('Logic Table Structural Consistency', () => {
  ...
  describe('Tier 3: Cross-registry completeness', () => {
    ...
    test('logic table registry contains exactly 38 families', () => {
      const registryKeys = Object.keys(logicTableRegistry).sort();
      expect(registryKeys).toHaveLength(38);
      expect(registryKeys).toEqual([...ALL_FAMILY_IDS].sort());
    });

    test('context questions cover all 38 families', () => {
