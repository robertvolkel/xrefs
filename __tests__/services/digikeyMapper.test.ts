...
describe('digikeyMapper', () => {
  describe('mapCategory (via mapDigikeyProductToPart)', () => {
    const cases: [string, string][] = [
      ...
      ['FPGAs - Field Programmable Gate Arrays', 'Processors'],
      ['Embedded - Microprocessors', 'Processors'],
      ['Embedded - CPLDs', 'Processors'],
      ['Memory', 'Memory'],
      ['EEPROM', 'Memory'],
      ['Sensors - Temperature', 'Sensors'],
      ['Sensors, Transducers', 'Sensors'],
      ['Encoders', 'Sensors'],
      ['RF/IF and RFID', 'RF and Wireless'],
      ['Antennas', 'RF and Wireless'],
      ['LED Indication - Discrete', 'LEDs and Optoelectronics'],
      ['Display Modules', 'LEDs and Optoelectronics'],
      ['Optoelectronics - Misc', 'LEDs and Optoelectronics'],
      ['Power Supplies - Board Mount', 'Power Supplies'],
      ['AC DC Converters', 'Power Supplies'],
      ['Transformers - Audio', 'Transformers'],
      ['Switches - Tactile', 'Switches'],
      ['DIP Switches', 'Switches'],
      ['Cable Assemblies', 'Cables and Wires'],
      ['Wire', 'Cables and Wires'],
      ['EMI/RFI Filters', 'Filters'],
      ['Audio Products - Speakers', 'Audio'],
      ['Microphones', 'Audio'],
      ['Fans - DC', 'Motors and Fans'],
      ['Motors - AC, DC', 'Motors and Fans'],
      ['Test and Measurement Equipment', 'Test and Measurement'],
      ['Development Boards', 'Development Tools'],
      ['Battery Chargers', 'Battery Products'],
